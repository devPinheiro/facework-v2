        ...
        <div>
            <div className="block border-grey-lightest px-1 pt-2">
                <div className="flex flex-wrap justify-between">
                    ...
                    >
                        <img
                            className="rounded-full h-6 w-6 object-cover border-grey-lightest border"
                            src={profile.image}
                            alt=""
                        />
                        <div className="flex-column h-6 ml-2">
                            <p className="text-xxs text-grey-dark mb-1">
                                {profile.name}
                            </p>
                            <small className="text-xxxs text-grey-light">
