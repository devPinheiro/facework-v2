    ...
    return (
        <>
            <div className="max-w-xl mx-auto px-4 py-4 bg-white shadow-md rounded-lg my-10">
                <div
                    className="py-4 flex flex-row items-center justify-between border-grey-lightest border-b-2 cursor-pointer rounded-sm"
                    onClick={() => setPostModalVisibility(!postModalVisibility)}
                >
                    <div className="flex flex-row items-center ">
                        <img
                            ...
                            alt=""
                        />
                        <p className="ml-3 text-sm md:text-xl text-form-transparent">
                ...
                <div className="mt-2">
                    <div className="pt-2 flex-column items-center">
                        <div className="flex flex-row justify-between">
                            ...
                            >
                                <Camera />
                                <p className="ml-2 text-grey-dark text-xs md:text-sm">
                                    Photo
                                </p>
                            </button>
                            <button
                            ...
                            <button
                                ...
                                className="flex-row items-center hidden md:flex  focus:outline-none focus:shadow-outline rounded-lg ml-3"
                            >
                                <Edit />
                                <p className="ml-2 text-grey-dark text-xs md:text-sm">
                                    Write an Article
