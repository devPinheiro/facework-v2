  ...
  return (
    <div className={`block border-grey-lightest px-2 py-2 hover:bg-grey-lightest ${read_at ? '' : 'bg-grey-lightest'}`}>
      ...
      ? <div className="flex justify-between">
            ...
            <img className="rounded-full h-10 w-10 object-cover border-grey-lightest border mr-3" src={data.sender.image} alt="" />
          ...
          <div className="px-4 pr-2 flex">
            <img className="h-12 w-16" src={data.sender.image} alt="" />
          </div>
        </div>
        :
        <div className="flex justify-between"> 
          ...
          <img className="rounded-full h-10 w-10 object-cover border-grey-lightest border mr-3" src={data.post_author_avatar} alt="" />
          <div className="flex-column ">
            <div>
          ...
          <div className="px-4 pr-2 flex">
            <img className="h-12 w-16" src={data.post_image} alt="" />
          </div>
        </div>
      }
    </div>
