...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "default", function() { return /* reexport */ ForgotPassword; });
...
// CONCATENATED MODULE: ./client/components/ForgotPasswordForm/ForgotPasswordForm.js
...
var ForgotPasswordForm_ForgotPasswordForm = function ForgotPasswordForm(_ref) {
  ...
  return /*#__PURE__*/react_default.a.createElement(react["Fragment"], null, /*#__PURE__*/react_default.a.createElement("div", {
    ...
    className: "bg-white-900 shadow-md pb-8 pt-8 pl-4 pr-4 md:pl-16 md:pr-16 rounded-lg w-full bg-form-transparent mb-4 md:mb-32"
  }, /*#__PURE__*/react_default.a.createElement("h2", {
    className: "text-center font-primary font-semibold mb-8"
  }, "Forgot Password"), /*#__PURE__*/react_default.a.createElement(formik_esm["a" /* Formik */], {
    onSubmit: onSubmit,
    ...
    className: "mt-2 text-white flex justify-center pb-4 md:pb-32"
  }, /*#__PURE__*/react_default.a.createElement("div", {
    className: ""
...
ForgotPasswordForm_ForgotPasswordForm.propTypes = {
...
/* harmony default export */ var components_ForgotPasswordForm_ForgotPasswordForm = (ForgotPasswordForm_ForgotPasswordForm);
// CONCATENATED MODULE: ./client/components/ForgotPasswordForm/index.js
...
// CONCATENATED MODULE: ./client/pages/ForgotPassword/ForgotPassword.js
...
var ForgotPassword_ForgotPasswordPage = /*#__PURE__*/function (_Component) {
  inherits_default()(ForgotPasswordPage, _Component);
  ...
  function ForgotPasswordPage() {
    ...
    classCallCheck_default()(this, ForgotPasswordPage);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "ForgotPasswordSchema", validation_schemas["b" /* ForgotPasswordSchema */]);
    ...
    defineProperty_default()(assertThisInitialized_default()(_this), "onSubmit", function (data, _ref) {
      ...
      dispatch(Object(auth["h" /* postForgotPassword */])(data)).then(function () {
        history.push('/');
        dispatch(Object(lib["flashMessage"])('Password reset link sent.'));
...
defineProperty_default()(ForgotPassword_ForgotPasswordPage, "propTypes", {
...
/* harmony default export */ var ForgotPassword = (Object(es["b" /* connect */])()(ForgotPassword_ForgotPasswordPage));
// CONCATENATED MODULE: ./client/pages/ForgotPassword/index.js
